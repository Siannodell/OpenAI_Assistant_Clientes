...
st.sidebar.write("<a style='color: white; text-decoration: none; position: absolute; top: -80px;' href='https://aisasschleba.netlify.app/' id='voltar'><< VOLTAR</a><br><a style='color:white'  href='https://www.google.com.br/' id='baixarArquivo'>[Baixe o arquivo para fazer a análise]</a>", unsafe_allow_html=True)
