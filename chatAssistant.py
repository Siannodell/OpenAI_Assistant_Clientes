...
if on:
    ...
    st.sidebar.write('<a target="_self" href="javascript:(function(){var conteudo = document.getElementById(\'idDoElemento\').innerText; console.log(conteudo);})()">Clique aqui para copiar</a>', unsafe_allow_html=True)
